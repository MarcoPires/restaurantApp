data = {
	'upload_folder' : 'restaurantApp/static/img/uploads',
	'read_folder' : 'static/img/uploads',
	'allowed_extensions' : ['txt', 'pdf', 'png', 'jpg', 'jpeg', 'gif'],
	
	'google_data' : 'restaurantApp/data/gg_client_secrets.json',
	...
	'facebook_data' : 'restaurantApp/data/fb_client_secrets.json',
